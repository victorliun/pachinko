...
def test_add_cash_payout():
    ...
    desire_data = [
        ...
        {'date':'2014-05-27', 'time_of_win': '14:46', 'win_number':4, 'renchan':0, 'spin_count_of_win':927, 'cash':-34380, 'balls':-8595, 'balls_won':1870, 'cashout':6676, 'cash_result':-37116},
        {'date':'2014-05-27', 'time_of_win': 'NaN', 'win_number':'--', 'renchan':0, 'spin_count_of_win':411 , 'cash':-11180, 'balls':-2795, 'balls_won':0, 'cashout':0, 'cash_result':-54972},
    ]
